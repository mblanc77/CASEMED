...
{
    public partial class AddRecetaDistancium
    {
        [Inject]
        ...
        {
            recetaDistancium = new SgpaNew.Server.Models.Sgpa.RecetaDistancium();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateRecetaDistancium(recetaDistancium);
