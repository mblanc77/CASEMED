...
{
    public partial class AddSubsidioCabezalEmpresa
    {
        [Inject]
        ...
        {
            subsidioCabezalEmpresa = new SgpaNew.Server.Models.Sgpa.SubsidioCabezalEmpresa();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateSubsidioCabezalEmpresa(subsidioCabezalEmpresa);
