...
{
    public partial class AddSubsidioEnfermedad
    {
        [Inject]
        ...
        {
            subsidioEnfermedad = new SgpaNew.Server.Models.Sgpa.SubsidioEnfermedad();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateSubsidioEnfermedad(subsidioEnfermedad);
