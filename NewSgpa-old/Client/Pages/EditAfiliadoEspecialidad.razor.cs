...
{
    public partial class EditAfiliadoEspecialidad
    {
        [Inject]
        ...
        {
            afiliadoEspecialidad = await SgpaService.GetAfiliadoEspecialidadByAfiliadoEspecialidadId(afiliadoEspecialidadId:AfiliadoEspecialidadId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.UpdateAfiliadoEspecialidad(afiliadoEspecialidadId:AfiliadoEspecialidadId, afiliadoEspecialidad);
