...
{
    public partial class AddPrimaFallecimiento
    {
        [Inject]
        ...
        {
            primaFallecimiento = new SgpaNew.Server.Models.Sgpa.PrimaFallecimiento();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreatePrimaFallecimiento(primaFallecimiento);
