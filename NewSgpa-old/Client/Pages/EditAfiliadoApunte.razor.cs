...
{
    public partial class EditAfiliadoApunte
    {
        [Inject]
        ...
        {
            afiliadoApunte = await SgpaService.GetAfiliadoApunteByAfiliadoApunteId(afiliadoApunteId:AfiliadoApunteId);
        }
        protected bool errorVisible;
        protected SgpaNew.Server.Models.Sgpa.AfiliadoApunte afiliadoApunte;
        ...
        protected async Task afiliadosForCILoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(afiliadoApunte.CI, null))
                {
                    var valueResult = await SgpaService.GetAfiliados(filter: $"CI eq {afiliadoApunte.CI}");
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.UpdateAfiliadoApunte(afiliadoApunteId:AfiliadoApunteId, afiliadoApunte);
                ...
                DialogService.Close(afiliadoApunte);
            }
            catch (Exception ex)
            {
                errorVisible = true;
