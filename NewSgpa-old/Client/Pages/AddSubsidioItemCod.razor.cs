...
{
    public partial class AddSubsidioItemCod
    {
        [Inject]
        ...
        {
            subsidioItemCod = new SgpaNew.Server.Models.Sgpa.SubsidioItemCod();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateSubsidioItemCod(subsidioItemCod);
