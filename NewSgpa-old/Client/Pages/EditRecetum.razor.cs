...
{
    public partial class EditRecetum
    {
        [Inject]
        ...
        {
            recetum = await SgpaService.GetRecetumByRecetaId(recetaId:RecetaId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.UpdateRecetum(recetaId:RecetaId, recetum);
