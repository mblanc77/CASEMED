...
{
    public partial class AddSubsidioItemEmpresa
    {
        [Inject]
        ...
        {
            subsidioItemEmpresa = new SgpaNew.Server.Models.Sgpa.SubsidioItemEmpresa();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateSubsidioItemEmpresa(subsidioItemEmpresa);
