...
{
    public partial class EditCertificacionProrroga
    {
        [Inject]
        ...
        {
            certificacionProrroga = await SgpaService.GetCertificacionProrrogaByCertificacionProrrogaId(certificacionProrrogaId:CertificacionProrrogaId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.UpdateCertificacionProrroga(certificacionProrrogaId:CertificacionProrrogaId, certificacionProrroga);
