...
{
    public partial class EditEmpresaPago
    {
        [Inject]
        ...
        {
            empresaPago = await SgpaService.GetEmpresaPagoByEmpresaPagoId(empresaPagoId:EmpresaPagoId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.UpdateEmpresaPago(empresaPagoId:EmpresaPagoId, empresaPago);
