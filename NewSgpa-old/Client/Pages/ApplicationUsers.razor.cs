...
namespace SgpaNew.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<SgpaNew.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<SgpaNew.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(SgpaNew.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(SgpaNew.Server.Models.ApplicationUser user)
        {
            try
            {
