...
{
    public partial class AddReintegroMutual
    {
        [Inject]
        ...
        {
            reintegroMutual = new SgpaNew.Server.Models.Sgpa.ReintegroMutual();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateReintegroMutual(reintegroMutual);
