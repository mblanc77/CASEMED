...
{
    public partial class EditSubsidioItemEmpresa
    {
        [Inject]
        ...
        {
            subsidioItemEmpresa = await SgpaService.GetSubsidioItemEmpresaBySubsidioItemEmpresaId(subsidioItemEmpresaId:SubsidioItemEmpresaId);
        }
        protected bool errorVisible;
        protected SgpaNew.Server.Models.Sgpa.SubsidioItemEmpresa subsidioItemEmpresa;
        ...
        protected async Task empresasForCodEmpresaLoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(subsidioItemEmpresa.CodEmpresa, null))
                {
                    var valueResult = await SgpaService.GetEmpresas(filter: $"CodEmpresa eq {subsidioItemEmpresa.CodEmpresa}");
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.UpdateSubsidioItemEmpresa(subsidioItemEmpresaId:SubsidioItemEmpresaId, subsidioItemEmpresa);
                ...
                DialogService.Close(subsidioItemEmpresa);
            }
            catch (Exception ex)
            {
                errorVisible = true;
