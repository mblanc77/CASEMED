...
{
    public partial class AddSubsidiocabezalBp
    {
        [Inject]
        ...
        {
            subsidiocabezalBp = new SgpaNew.Server.Models.Sgpa.SubsidiocabezalBp();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateSubsidiocabezalBp(subsidiocabezalBp);
