...
{
    public partial class EditMutualistum
    {
        [Inject]
        ...
        {
            mutualistum = await SgpaService.GetMutualistumByCodMutualista(codMutualista:CodMutualista);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.UpdateMutualistum(codMutualista:CodMutualista, mutualistum);
