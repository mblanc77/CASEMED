...
{
    public partial class EditImponible
    {
        [Inject]
        ...
        [Parameter]
        public int ImponibleId { get; set; }

        protected override async Task OnInitializedAsync()
        {
            imponible = await SgpaService.GetImponibleByImponibleId(imponibleId:ImponibleId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.UpdateImponible(imponibleId:ImponibleId, imponible);
