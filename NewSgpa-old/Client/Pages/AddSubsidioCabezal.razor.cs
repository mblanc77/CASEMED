...
{
    public partial class AddSubsidioCabezal
    {
        [Inject]
        ...
        {
            subsidioCabezal = new SgpaNew.Server.Models.Sgpa.SubsidioCabezal();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateSubsidioCabezal(subsidioCabezal);
