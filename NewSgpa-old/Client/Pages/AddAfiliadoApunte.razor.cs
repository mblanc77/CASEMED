...
{
    public partial class AddAfiliadoApunte
    {
        [Inject]
        ...
        {
            afiliadoApunte = new SgpaNew.Server.Models.Sgpa.AfiliadoApunte();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateAfiliadoApunte(afiliadoApunte);
