...
{
    public partial class AddAdPreJubPago
    {
        [Inject]
        ...
        {
            adPreJubPago = new SgpaNew.Server.Models.Sgpa.AdPreJubPago();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SgpaService.CreateAdPreJubPago(adPreJubPago);
