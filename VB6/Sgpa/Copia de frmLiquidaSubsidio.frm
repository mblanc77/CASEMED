...
Private Function LiquidarSubsidio(Optional pbLiquidar As Boolean = True) As Boolean
    ...
    Dim lMes As Long, lMesIni As Long, lAnioIni As Long
    ...
    With rs
        ...
        Do While Not .EOF
            ...
            Do While Not rsTmp.EOF
                ...
                ValorJornal rsTmp, lIDSubsidio, lMes, lMesIni, lAnioIni, tAfiliado, pbLiquidar
...
Private Sub ValorJornal(rsTmp As Recordset, plIdSubsidio As Long, plMes As Long, plMesIni As Long, plAnioIni As Long, ptafiliado As tAfiliados, pbLiquidar As Boolean)
    ...
    With rsTmp
        'Do While Not .EOF
            ...
            If dIni = !FechaIni Then
                If DescontarDia(ptafiliado.lCI, !FechaIni) And Not !Internado Then  'Si es internado no se descuenta el primer día
                    lDias = lDias - 1
                End If
            End If
    ...
    With rs
        Do While Not .EOF
            If rsTmp.EOF Then
                ...
                rsTmp!Internado = (!CodSalidaTipo = PC_SALIDATIPO_INTERNADO)
                rsTmp.Update
