...
Begin VB.Form frmDBG_SituacionMutual 
   Caption         =   "Mantenimiento de Situación Mutual"
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8370
   ...
   Begin VB.Data dat 
      ...
      RecordSource    =   "Rs_SituacionMutual"
      Top             =   3870
      Width           =   7455
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":059C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":0B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":10D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":1230
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":138C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":14E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":1644
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":18FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":1E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":2434
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrSitMut.frx":29D0
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrSitMut.frx":2B2C
      Height          =   3435
      Left            =   150
      OleObjectBlob   =   "GrSitMut.frx":2B3E
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
   ...
   End
End
Attribute VB_Name = "frmDBG_SituacionMutual"
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_CODSITUACIONMUTUAL, "S", "Código", "OBS", 2, "", "", "txtCodRegimenJubilatorio", MC_TABLA
        oConf.AddItem C_DESCRIP, "S", "Descripción", "OBS", 50, "", "", "txtDescrip", MC_TABLA
        oConf.AddItem C_PAGAR, "B", "Pagar", "OBS", 50, "", "", "txtDescrip", MC_TABLA
...
Private Sub dbg_BeforeUpdate(Cancel As Integer)
   ...
   On Local Error Resume Next
    With dbg.Columns
        'If .Item(oConf.cListIndex(C_CODSALIDATIPO) - 1).Text = "" Then
        '    .Item(oConf.cListIndex(C_CODSALIDATIPO) - 1).Text = ProxNro()
        'End If
...
'
'    Set rsProx = db.OpenRecordset("001_SalidaTipo_Max", dbOpenSnapshot)
'    ProxNro = rsProx!Max
'    rsProx.Close
'    Set rsProx = Nothing
'
