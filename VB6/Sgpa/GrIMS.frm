...
Begin VB.Form frmDBG_IMS 
   Caption         =   "Mantenimiento de I.M.S."
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8370
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":059C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":0B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":10D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":1230
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":138C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":14E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":1644
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":18FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":1E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":2434
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrIMS.frx":29D0
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrIMS.frx":2B2C
      Height          =   3435
      Left            =   150
      OleObjectBlob   =   "GrIMS.frx":2B3E
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
...
Private Const MC_TABLA = "IMS"
Private Const MC_REPORT = "IMS"
...
Private Const C_ANIOMES = "[AnioMes]"
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_MES, "N", "Mes", "OBS", 2, "", "", "txtCodSituacionPago", MC_TABLA
        oConf.AddItem C_ANIO, "N", "Año", "OBS", 4, "", "", "txtCodSituacionPago", MC_TABLA
        oConf.AddItem C_IMPORTE, "N", "Importe", "OBS", 11, "", "", "txtCodSituacionPago", MC_TABLA
        oConf.AddItem C_ANIOMES, "N", "", "V", 5, "", "", "txtCodSituacionPago", MC_TABLA
        oConf.AddItem C_USR, "S", "Usuario", "OBSLG", 8, "", "", "txtUsr", MC_TABLA
        oConf.AddItem C_TS, "D", "Ult.Modif.", "OBSLG", 10, "", "dd/mm/yyyy", "txtTs", MC_TABLA
'END_FIELD
...
Private Sub dbg_BeforeUpdate(Cancel As Integer)
   ...
   On Local Error Resume Next
    With dbg.Columns
        'If .Item(oConf.cListIndex(C_CODSITUACIONPAGO) - 1).Text = "" Then
        '    .Item(oConf.cListIndex(C_CODSITUACIONPAGO) - 1).Text = ProxNro()
        'End If
        .Item(oConf.cListIndex(C_ANIOMES) - 1) = Val(CStr(.Item(oConf.cListIndex(C_ANIO) - 1)) & Format(.Item(oConf.cListIndex(C_MES) - 1), "00"))
...
Private Function ProxNro() As Long
    ...
    Set rsProx = db.OpenRecordset("001_SituacionPago_Max", dbOpenSnapshot)
    ProxNro = rsProx!Max
    rsProx.Close
    Set rsProx = Nothing
