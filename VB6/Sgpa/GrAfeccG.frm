...
Begin VB.Form frmDBG_AfeccionGrupo 
   Caption         =   "Mantenimiento de Grupos de Afección"
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8370
   ...
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrAfeccG.frx":0000
      Height          =   3435
      Left            =   90
      OleObjectBlob   =   "GrAfeccG.frx":0012
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":38F7
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":3E93
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":442F
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":49CB
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":4B27
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":4C83
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":4DDF
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":4F3B
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":5097
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":51F3
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":578F
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":5D2B
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAfeccG.frx":62C7
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmDBG_AfeccionGrupo"
...
Private Const MC_TABLA = "Rs_AfeccionGrupo"
Private Const MC_REPORT = "Rs_AfeccionGrupo"
Private Const C_AUTO_NUMBER = True

'BEGIN_CONST
Private Const C_CODAFECCIONGRUPO = "[CodAfeccionGrupo]"
Private Const C_DESCRIP = "[Descrip]"
Private Const C_CODPATOLOGIA = "[CodPatologia]"
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_CODAFECCIONGRUPO, "N", "Código", "OBSL", 5, "", "", "txtCodAfeccionTipo", "[AfeccionTipo]"
        oConf.AddItem C_DESCRIP, "S", "Descripción", "OBS", 50, "", "", "txtDescrip", "[AfeccionTipo]"
        oConf.AddItem C_CODPATOLOGIA, "NC", "Patología", "OBS", 5, "", "", "txtCodAfeccionTipo", "[AfeccionTipo]"
        oConf.AddItem C_USR, "S", "Usuario", "OBSLG", 8, "", "", "txtUsr", "[AfeccionTipo]"
        oConf.AddItem C_TS, "D", "Ult.Modif.", "OBSLG", 10, "", "", "txtTs", "[AfeccionTipo]"
'END_FIELD

'BEGIN_COMBO
        oConf.CboAddItem C_CODPATOLOGIA, "Rs_Patologia_Desc", "[CodPatologia]", "[Descrip]"
'END_COMBO
    oConf.Init
