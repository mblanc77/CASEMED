...
Begin VB.Form frmDBG_EmpresaPago 
   Caption         =   "Mantenimiento de Pagos de Empresas"
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8370
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":059C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":0B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":10D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":1230
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":138C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":14E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":1644
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":18FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":1E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":2434
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrEmpres.frx":29D0
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrEmpres.frx":2B2C
      Height          =   3435
      Left            =   120
      OleObjectBlob   =   "GrEmpres.frx":2B3E
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
   ...
   End
End
Attribute VB_Name = "frmDBG_EmpresaPago"
...
Private Const MC_TABLA = "Rs_EmpresaPago"
Private Const MC_REPORT = "Rs_EmpresaPAgo"
...
Private Sub dbg_FormatText(ByVal ColIndex As Integer, Value As Variant, Bookmark As Variant)
    
    If dbg.Columns(ColIndex).DataField = SacarRectos(C_IMPORTE) Then
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_CODEMPRESA, "NC", "Empresa", "OBS", 5, "", "", "txtCodEmpresa", "[Rs_EmpresaPago]"
        oConf.AddItem C_MES, "N", "Mes", "OBS", 5, "", "", "txtMes", "[Rs_EmpresaPago]"
        oConf.AddItem C_ANIO, "N", "Año", "OBS", 9, "", "", "txtAnio", "[Rs_EmpresaPago]"
        oConf.AddItem C_IMPORTE, "X", "Importe", "OBS", 8, "", "", "txtImporte", "[Rs_EmpresaPago]"
        oConf.AddItem C_USR, "S", "Usuario", "OBSLG", 8, "", "", "txtUsr", "[Rs_EmpresaPago]"
        oConf.AddItem C_TS, "D", "Ult.Modif.", "OBSLG", 10, "", "dd/mm/yyyy", "txtTs", "[Rs_EmpresaPago]"
'END_FIELD
