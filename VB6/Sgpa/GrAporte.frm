...
Begin VB.Form frmDBG_AporteTipo 
   Caption         =   "Mantenimiento de Tipos de Aporte"
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8220
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":059C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":0B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":10D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":1230
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":138C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":14E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":1644
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":18FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":1E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":2434
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrAporte.frx":29D0
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrAporte.frx":2B2C
      Height          =   3435
      Left            =   120
      OleObjectBlob   =   "GrAporte.frx":2B3E
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
   ...
   End
End
Attribute VB_Name = "frmDBG_AporteTipo"
...
Private Const MC_TABLA = "Rs_AporteTipo"
Private Const MC_REPORT = "Rs_AporteTipo"
Private Const C_AUTO_NUMBER = False

'BEGIN_CONST
Private Const C_CODAPORTETIPO = "[CodAporteTipo]"
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_CODAPORTETIPO, "S", "Código", "OBS", 3, "", "", "txtCodAporteTipo", "[AporteTipo]"
        oConf.AddItem C_DESCRIP, "S", "Descripción", "OBS", 50, "", "", "txtDescrip", "[AporteTipo]"
        oConf.AddItem C_USR, "S", "Usuario", "OBSLG", 8, "", "", "txtUsr", "[AporteTipo]"
        oConf.AddItem C_TS, "D", "Ult.Modif.", "OBSLG", 10, "", "dd/mm/yyyy", "txtTs", "[AporteTipo]"
'END_FIELD
...
'    On Error Resume Next
'    With oConf
'        sField = .cField(dbg.Col + 1)
'        sDesc = .cDescription(dbg.Col + 1)
'        If Err > 0 Then
'            Exit Sub
'        End If
'        s = oConf.WhereSelect
...
'    On Error GoTo 0
'
'    sql = "SELECT " & sField & " As Valor, Count(*) As Cuenta From " & MC_TABLA & IIf(s <> "", " where " & s, "") & " GROUP BY " & sField
'    Set rsChart = db.OpenRecordset(sql, dbOpenSnapshot)
'    DBEngine.Idle dbFreeLocks
'    With rsChart
'        If .RecordCount > 0 Then
'            .MoveLast
'            ReDim args(1 To .RecordCount, 1 To 3) As String
'            For i = .RecordCount To 1 Step -1
'                args(i, 1) = .Fields("Cuenta")
'                args(i, 2) = .Fields("Cuenta")
'                args(i, 3) = "- ' " & .Fields("Valor") & " '"
'                .MovePrevious
'            Next i
'            xChart.param_CallForm Me.Name, args, sDesc
'            xChart.Show Modal
'        End If
'    End With
'    rsChart.Close
