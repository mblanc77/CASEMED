...
Begin VB.Form frmDBG_RegimenJubilatorio 
   Caption         =   "Mantenimiento de Regímenes Jubilatorios"
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8370
   ...
   Begin VB.Data dat 
      Connect         =   ";pwd=XXXXXX"
      DatabaseName    =   "C:\gestion\Sgpa\Sgpa.mdb"
      ...
      RecordSource    =   "RegimenJubilatorio"
      Top             =   3870
      Width           =   7455
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":059C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":0B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":10D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":1230
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":138C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":14E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":1644
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":18FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":1E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":2434
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRegime.frx":29D0
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrRegime.frx":2B2C
      Height          =   3435
      Left            =   150
      OleObjectBlob   =   "GrRegime.frx":2B3E
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
   ...
   End
End
Attribute VB_Name = "frmDBG_RegimenJubilatorio"
...
Private Const MC_TABLA = "Rs_RegimenJubilatorio"
Private Const MC_REPORT = "Rs_RegimenJubilatorio"
...
Private Const C_CALCULOTIPO = "[CalculoTipo]"
Private Const C_IMPORTE = "[Importe]"
Private Const C_MESVIGVALOR = "[MesVigValor]"
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_CODREGIMENJUBILATORIO, "X", "Código", "OBS", 1, "", "", "txtCodRegimenJubilatorio", "[RegimenJubilatorio]"
        oConf.AddItem C_DESCRIP, "S", "Descripción", "OBS", 50, "", "", "txtDescrip", "[RegimenJubilatorio]"
        oConf.AddItem C_CALCULOTIPO, "S", "T. Cálculo", "OBS", 3, "", "", "txtDescrip", "[RegimenJubilatorio]"
        oConf.AddItem C_IMPORTE, "N", "Importe", "OBS", 50, "", "", "txtDescrip", "[RegimenJubilatorio]"
        oConf.AddItem C_MESVIGVALOR, "N", "Vigencia", "OBS", 6, "", "", "txtDescrip", "[RegimenJubilatorio]"
        oConf.AddItem C_USR, "S", "Usuario", "OBSLG", 8, "", "", "txtUsr", "[RegimenJubilatorio]"
        oConf.AddItem C_TS, "D", "Ult.Modif.", "OBSLG", 10, "", "dd/mm/yyyy", "txtTs", "[RegimenJubilatorio]"
'END_FIELD
...
Private Sub dbg_BeforeUpdate(Cancel As Integer)
   ...
   On Local Error Resume Next
    With dbg.Columns
        If .Item(oConf.cListIndex(C_CODREGIMENJUBILATORIO) - 1).Text = "" Then
            .Item(oConf.cListIndex(C_CODREGIMENJUBILATORIO) - 1).Text = ProxNro()
        End If
...
Private Function ProxNro() As Long
    ...
    Set rsProx = db.OpenRecordset("001_RegimenJubilatorio_Max", dbOpenSnapshot)
    ProxNro = rsProx!Max
    rsProx.Close
    Set rsProx = Nothing
