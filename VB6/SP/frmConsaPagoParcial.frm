...
Begin VB.Form frmConsPagoParcial 
   Caption         =   "Pagos Parciales Efectuados"
   ClientHeight    =   3870
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5310
   ...
   Begin VB.Data dat 
      Caption         =   "Data1"
      Connect         =   ";pwd=mbsp"
      DatabaseName    =   "C:\Opc6\Extras\Programas\gestion\sp\SP.mdb"
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsaPagoParcial.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsaPagoParcial.frx":08DA
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button2 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Key             =   "nuevo"
            Object.ToolTipText     =   "Nuevo pago parcial"
            ImageIndex      =   2
         EndProperty
      EndProperty
   End
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "frmConsaPagoParcial.frx":12E0
      Height          =   2985
      Left            =   60
      OleObjectBlob   =   "frmConsaPagoParcial.frx":12F2
      TabIndex        =   1
      Top             =   30
      Width           =   4485
   End
End
Attribute VB_Name = "frmConsPagoParcial"
...
Private Sub ConfigDbg()
    ...
    With dbg
        ...
        With .Columns
            .Item("TasaCambio").Caption = "Tipo cambio"
...
Private Sub CargarDatos()
    ...
    Dim oPagoParcial As cAdmPagoParcial: Set oPagoParcial = New cAdmPagoParcial
    Dim rs As Recordset: Set rs = oPagoParcial.AbrirPagosPorPrestamoRS(Me.IDPrestamo)
    rs.Sort = "Fecha desc"
    ...
    With dat.Recordset
        If .RecordCount > 0 Then
            Toolbar1.Buttons("eliminar").Enabled = (.AbsolutePosition + 1 = .RecordCount) And _
                oUsr.FormsSeg(Me.Name).PermisoObj("eliminar")
        End If
    End With
