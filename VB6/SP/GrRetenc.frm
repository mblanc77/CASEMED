...
Begin VB.Form frmDBGRpt_Retencion 
   Caption         =   "Informe de retenciones envíadas"
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8370
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":059C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":0B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":10D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":1230
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":138C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":14E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":1644
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":18FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":1E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":2434
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":29D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetenc.frx":2B2C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Data dat 
      ...
      RecordSource    =   "Rpt_Retencion"
      Top             =   3870
      Width           =   7455
   End
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrRetenc.frx":3560
      Height          =   3435
      Left            =   120
      OleObjectBlob   =   "GrRetenc.frx":3572
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
   ...
   End
End
Attribute VB_Name = "frmDBGRpt_Retencion"
...
Private Const MC_TABLA = "Rpt_Retencion"
Private Const MC_REPORT = "Rpt_Retencion"
...
Private Const C_TIPOCAMBIO = "[TipoCambio]"
...
Private Const C_IMPMORA = "[ImpMora]"
Private Const C_IMPTEL = "[ImpTel]"
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_IDPRESTAMO, "N", "Nro. Prestamo", "OBS", 9, "", "", "txtDireccion", ""
        oConf.AddItem C_CODEMPRESA, "SC", "Empresa", "BVS", 25, "", "", "txtFax", ""
        oConf.AddItem C_DESCEMPRESA, "S", "Empresa", "O", 25, "", "", "txtFax", ""
        oConf.AddItem C_CI, "N", "C.I.", "OBS", 9, "", "", "txtDireccion", "[SP_Factura]"
        oConf.AddItem C_FECHA, "D", "Fecha", "OBS", 5, "", "", "txtCodCertificador", ""
        oConf.AddItem C_TIPOCAMBIO, "N", "T. Cambio", "OBS", 25, "", "#,##0.00", "txtFax", ""
        oConf.AddItem C_CODMONEDA, "SC", "Moneda", "OBS", 25, "", "", "txtFax", ""
        oConf.AddItem C_IMPORTE, "N", "Importe", "OBS", 25, "", "#,##0.00", "txtFax", ""
        oConf.AddItem C_IMPAMORTIZABLE, "N", "Imp. Amort.", "OBS", 25, "", "#,##0.00", "txtFax", ""
        oConf.AddItem C_IMPINTERES, "N", "Imp. Intereses", "OBS", 25, "", "#,##0.00", "txtFax", ""
        oConf.AddItem C_IMPMORA, "N", "Imp. Mora", "OBS", 25, "", "#,##0.00", "txtFax", ""
        oConf.AddItem C_IMPTEL, "N", "Imp. Telegrama", "OBS", 25, "", "#,##0.00", "txtFax", ""
        oConf.AddItem C_OBSERVACIONES, "X", "Obseravciones", "OBS", 8, "", "", "txtUsr", ""
        oConf.AddItem C_USR, "S", "Usuario", "OBS", 8, "", "", "txtUsr", ""
        oConf.AddItem C_TS, "D", "Ult.Modif.", "OBS", 10, "", "", "txtTs", ""
'END_FIELD

'BEGIN_COMBO
        oConf.CboAddItem C_CODEMPRESA, "Rs_Empresa_Descrip", "[CodEmpresa]", "[Descrip]"
...
Private Sub ConfigDbg(Optional p_bAddNew As Boolean = True _
    ...
    With dbg
        ...
        With .Columns
            ...
            .Item("ImpMora").NumberFormat = "#,##0.00"
            .Item("ImpTel").NumberFormat = "#,##0.00"
            '.Item("Saldo").NumberFormat = "#,##0.00"
            .Item("TipoCambio").NumberFormat = "#,##0.00"
