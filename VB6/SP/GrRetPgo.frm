...
Begin VB.Form frmDBGRpt_RetencionPago 
   Caption         =   "Informe de cobro de retenciones"
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8370
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":059C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":0B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":10D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":1230
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":138C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":14E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":1644
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":18FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":1E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":2434
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":29D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrRetPgo.frx":2B2C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Data dat 
      ...
      RecordSource    =   "rpt_retencionpago"
      Top             =   3870
      Width           =   7455
   End
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrRetPgo.frx":3560
      Height          =   3435
      Left            =   120
      OleObjectBlob   =   "GrRetPgo.frx":3572
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
   ...
   End
End
Attribute VB_Name = "frmDBGRpt_RetencionPago"
...
Private Const MC_TABLA = "Rpt_RetencionPago"
Private Const MC_REPORT = "Rpt_RetencionPago"
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_IDPRESTAMO, "N", "Nro. Prestamo", "OBS", 9, "", "", "txtDireccion", "[SP_RetencionPago]"
        oConf.AddItem C_FECHA, "D", "Fecha", "OBS", 5, "", "", "txtCodCertificador", "[SP_RetencionPago]"
        oConf.AddItem C_CODEMPRESA, "NC", "Empresa", "BVS", 5, "", "", "txtCodCertificador", "[SP_Empresa]"
        oConf.AddItem C_DESCEMPRESA, "S", "Empresa", "O", 5, "", "", "txtCodCertificador", ""
        oConf.AddItem C_ANIO, "N", "Año", "OBS", 25, "", "", "txtFax", "[SP_RetencionPago]"
        oConf.AddItem C_MES, "N", "Mes", "OBS", 25, "", "00", "txtFax", "[SP_RetencionPago]"
        oConf.AddItem C_IMPORTE, "N", "Importe", "OBS", 25, "", "#,###,##0.00", "txtFax", "[SP_RetencionPago]"
        oConf.AddItem C_USR, "S", "Usuario", "OBS", 8, "", "", "txtUsr", "[SP_RetencionPago]"
        oConf.AddItem C_TS, "D", "Ult.Modif.", "OBS", 10, "", "", "txtTs", "[SP_RetencionPago]"
'END_FIELD

'BEGIN_COMBO
        oConf.CboAddItem C_CODEMPRESA, "Rs_Empresa_Descrip", "[CodEmpresa]", "[DescEmpresa]"
'END_COMBO
...
Private Sub ConfigDbg(Optional p_bAddNew As Boolean = True _
    ...
    With dbg
        ...
        With .Columns
            ...
            'm.Item("TasaCambio").NumberFormat = "###,###,##0.00"
        End With
        With .Splits(0)
