...
Begin VB.Form frmDBGRpt_Pago 
   Caption         =   "Informe de Pagos"
   ClientHeight    =   4695
   ClientLeft      =   1245
   ClientTop       =   2160
   ClientWidth     =   8370
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":059C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":0B38
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":10D4
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":1230
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":138C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":14E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":1644
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":18FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":1E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":2434
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":29D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":2B2C
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GrPago.frx":2C86
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TrueDBGrid60.TDBGrid dbg 
      Bindings        =   "GrPago.frx":36BA
      Height          =   3435
      Left            =   120
      OleObjectBlob   =   "GrPago.frx":36CC
      TabIndex        =   1
      Top             =   390
      Width           =   7425
   End
   ...
   End
End
Attribute VB_Name = "frmDBGRpt_Pago"
...
Private Const MC_TABLA = "Rpt_Pago"
Private Const MC_REPORT = "Rpt_Pago"
...
Private Const C_IMPFACTURA = "[ImpFactura]"
Private Const C_IMPINTERESMORA = "[ImpInteresMora]"
...
Private Const C_CODPAGOORIGEN = "[CodPagoOrigen]"
Private Const C_DESCPAGOORIGEN = "[DescPagoOrigen]"
...
Private Const cRptPagoPesos = "pagopes"
Private Const cRptPagoDolares = "pagodol"

Private Sub dbg_FetchRowStyle(ByVal Split As Integer, Bookmark As Variant, ByVal RowStyle As TrueDBGrid60.StyleDisp)

    Select Case dbg.Columns(SacarRectos(C_CODPAGOORIGEN)).CellValue(Bookmark)
        Case pcPagoOrigenRetencion
            RowStyle.ForeColor = vbRed
        Case pcPagoOrigenCasemed
            RowStyle.ForeColor = pcColorVerde
        Case pcPagoOrigenRefinanciacion
...
'BEGIN_FIELD
        ...
        oConf.AddItem C_NROFACTURA, "N", "Nro. Fac.", "OBS", 9, "", "", "txtDireccion", "[SP_Factura]"
        oConf.AddItem C_IDPRESTAMO, "N", "Nro. Prestamo", "OBS", 5, "", "", "txtCodCertificador", "[SP_Prestamo]"
        oConf.AddItem C_IMPORTE, "N", "Imp. Cobrado", "OBS", 25, "", "#,###,##0.00", "txtFax", "[SP_Pago]"
        oConf.AddItem C_IMPFACTURA, "N", "Imp. Facturado", "OBS", 25, "", "#,###,##0.00", "txtFax", "[SP_Factura]"
        oConf.AddItem C_IMPINTERESMORA, "N", "Int. x Mora", "OBS", 25, "", "#,###,##0.00", "txtFax", ""
        ...
        oConf.AddItem C_FECHAPAGO, "D", "F. Pago", "OBS", 10, "", "", "txtDireccion", ""
        oConf.AddItem C_CODSUCURSAL, "S", "Sucursal", "OBS", 255, "", "", "txtTelefono", "[SP_Pago]"
        oConf.AddItem C_CODMONEDA, "SC", "Moneda", "BVS", 25, "", "", "txtTelefono", "[SP_Factura]"
        oConf.AddItem C_DESCMONEDA, "S", "Moneda", "O", 25, "", "", "txtTelefono", ""
        oConf.AddItem C_IMPAMORTIZABLE, "N", "Imp. Amort.", "OBS", 25, "", "#,###,##0.00", "txtFax", "[SP_Factura]"
        oConf.AddItem C_IMPINTERES, "N", "Interes", "OBS", 25, "", "#,###,##0.00", "txtFax", "[SP_Factura]"
        oConf.AddItem C_CODPAGOORIGEN, "SC", "Origen", "BVS", 25, "", "", "txtTelefono", "[SP_Pago]"
        oConf.AddItem C_DESCPAGOORIGEN, "S", "Origen", "O", 25, "", "", "txtTelefono", ""
        oConf.AddItem C_USR, "S", "Usuario", "OBS", 8, "", "", "txtUsr", "[SP_Pago]"
        oConf.AddItem C_TS, "D", "Ult.Modif.", "OBS", 10, "", "", "txtTs", "[SP_Pago]"
'END_FIELD

'BEGIN_COMBO
        oConf.CboAddItem C_CODMONEDA, "Rs_Moneda_Descrip", "[CodMoneda]", "[Descrip]"
        oConf.CboAddItem C_CODPAGOORIGEN, "Rs_PagoOrigen_Descrip", "[CodPagoOrigen]", "[Descrip]"
'END_COMBO
...
Private Sub ConfigDbg(Optional p_bAddNew As Boolean = True _
    ...
    With dbg
        ...
        With .Columns
            ...
            .Item("ImpFactura").NumberFormat = "###,###,##0.00"
            .Item("ImpInteresMora").NumberFormat = "###,###,##0.00"
            .Item("ImpAmortizable").NumberFormat = "###,###,##0.00"
            .Item("ImpInteres").NumberFormat = "###,###,##0.00"
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    Case "leyenda"
        frmPagoColorLeyenda.Show vbModal
    End Select
