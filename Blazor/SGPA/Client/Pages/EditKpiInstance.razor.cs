...
{
    public partial class EditKpiInstance
    {
        [Inject]
        ...
        {
            kpiInstance = await CMUService.GetKpiInstanceByOid(oid:Oid);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateKpiInstance(oid:Oid, kpiInstance);
