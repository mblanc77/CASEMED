...
{
    public partial class AddSecuritySystemRole
    {
        [Inject]
        ...
        {
            securitySystemRole = new SGPA.Server.Models.CMU.SecuritySystemRole();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateSecuritySystemRole(securitySystemRole);
