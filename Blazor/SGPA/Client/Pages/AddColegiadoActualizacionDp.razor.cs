...
{
    public partial class AddColegiadoActualizacionDp
    {
        [Inject]
        ...
        {
            colegiadoActualizacionDp = new SGPA.Server.Models.CMU.ColegiadoActualizacionDp();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateColegiadoActualizacionDp(colegiadoActualizacionDp);
