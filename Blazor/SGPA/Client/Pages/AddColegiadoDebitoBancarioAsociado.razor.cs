...
{
    public partial class AddColegiadoDebitoBancarioAsociado
    {
        [Inject]
        ...
        {
            colegiadoDebitoBancarioAsociado = new SGPA.Server.Models.CMU.ColegiadoDebitoBancarioAsociado();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateColegiadoDebitoBancarioAsociado(colegiadoDebitoBancarioAsociado);
