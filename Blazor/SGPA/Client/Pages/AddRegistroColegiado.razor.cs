...
{
    public partial class AddRegistroColegiado
    {
        [Inject]
        ...
        {
            registroColegiado = new SGPA.Server.Models.CMU.RegistroColegiado();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateRegistroColegiado(registroColegiado);
