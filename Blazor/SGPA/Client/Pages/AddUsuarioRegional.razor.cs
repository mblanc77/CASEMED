...
{
    public partial class AddUsuarioRegional
    {
        [Inject]
        ...
        {
            usuarioRegional = new SGPA.Server.Models.CMU.UsuarioRegional();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateUsuarioRegional(usuarioRegional);
