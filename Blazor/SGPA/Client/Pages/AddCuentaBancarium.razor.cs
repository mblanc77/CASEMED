...
{
    public partial class AddCuentaBancarium
    {
        [Inject]
        ...
        {
            cuentaBancarium = new SGPA.Server.Models.CMU.CuentaBancarium();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateCuentaBancarium(cuentaBancarium);
