...
{
    public partial class EditTramiteInfoadjuntafotocarne
    {
        [Inject]
        ...
        {
            tramiteInfoadjuntafotocarne = await CMUService.GetTramiteInfoadjuntafotocarneByOid(oid:OID);
        }
        protected bool errorVisible;
        protected SGPA.Server.Models.CMU.TramiteInfoadjuntafotocarne tramiteInfoadjuntafotocarne;
        ...
        protected async Task tramiteInfoadjuntabasesForOIDLoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(tramiteInfoadjuntafotocarne.OID, null))
                {
                    var valueResult = await CMUService.GetTramiteInfoadjuntabases(filter: $"OID eq {tramiteInfoadjuntafotocarne.OID}");
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateTramiteInfoadjuntafotocarne(oid:OID, tramiteInfoadjuntafotocarne);
                ...
                DialogService.Close(tramiteInfoadjuntafotocarne);
            }
            catch (Exception ex)
            {
                errorVisible = true;
