...
{
    public partial class EditSecuritySystemTypePermissionsObject
    {
        [Inject]
        ...
        {
            securitySystemTypePermissionsObject = await CMUService.GetSecuritySystemTypePermissionsObjectByOid(oid:Oid);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateSecuritySystemTypePermissionsObject(oid:Oid, securitySystemTypePermissionsObject);
