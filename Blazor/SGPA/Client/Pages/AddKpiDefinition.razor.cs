...
{
    public partial class AddKpiDefinition
    {
        [Inject]
        ...
        {
            kpiDefinition = new SGPA.Server.Models.CMU.KpiDefinition();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateKpiDefinition(kpiDefinition);
