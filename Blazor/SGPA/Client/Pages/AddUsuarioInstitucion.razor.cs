...
{
    public partial class AddUsuarioInstitucion
    {
        [Inject]
        ...
        {
            usuarioInstitucion = new SGPA.Server.Models.CMU.UsuarioInstitucion();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateUsuarioInstitucion(usuarioInstitucion);
