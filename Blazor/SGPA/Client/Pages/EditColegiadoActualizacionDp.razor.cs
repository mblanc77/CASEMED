...
{
    public partial class EditColegiadoActualizacionDp
    {
        [Inject]
        ...
        {
            colegiadoActualizacionDp = await CMUService.GetColegiadoActualizacionDpById(id:Id);
        }
        protected bool errorVisible;
        protected SGPA.Server.Models.CMU.ColegiadoActualizacionDp colegiadoActualizacionDp;
        ...
        protected async Task colegiadosForColegiadoLoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(colegiadoActualizacionDp.Colegiado, null))
                {
                    var valueResult = await CMUService.GetColegiados(filter: $"Documento eq {colegiadoActualizacionDp.Colegiado}");
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateColegiadoActualizacionDp(id:Id, colegiadoActualizacionDp);
                ...
                DialogService.Close(colegiadoActualizacionDp);
            }
            catch (Exception ex)
            {
                errorVisible = true;
