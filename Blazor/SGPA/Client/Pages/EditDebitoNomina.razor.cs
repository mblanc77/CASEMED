...
{
    public partial class EditDebitoNomina
    {
        [Inject]
        ...
        {
            debitoNomina = await CMUService.GetDebitoNominaById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateDebitoNomina(id:Id, debitoNomina);
