...
{
    public partial class EditTramiteInfoadjuntabase
    {
        [Inject]
        ...
        {
            tramiteInfoadjuntabase = await CMUService.GetTramiteInfoadjuntabaseByOid(oid:OID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateTramiteInfoadjuntabase(oid:OID, tramiteInfoadjuntabase);
