...
{
    public partial class EditUsuarioAcceso
    {
        [Inject]
        ...
        {
            usuarioAcceso = await CMUService.GetUsuarioAccesoById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateUsuarioAcceso(id:Id, usuarioAcceso);
