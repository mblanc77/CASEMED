...
{
    public partial class AddAjusteDetalle
    {
        [Inject]
        ...
        {
            ajusteDetalle = new SGPA.Server.Models.CMU.AjusteDetalle();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateAjusteDetalle(ajusteDetalle);
