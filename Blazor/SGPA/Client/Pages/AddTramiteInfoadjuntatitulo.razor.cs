...
{
    public partial class AddTramiteInfoadjuntatitulo
    {
        [Inject]
        ...
        {
            tramiteInfoadjuntatitulo = new SGPA.Server.Models.CMU.TramiteInfoadjuntatitulo();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateTramiteInfoadjuntatitulo(tramiteInfoadjuntatitulo);
