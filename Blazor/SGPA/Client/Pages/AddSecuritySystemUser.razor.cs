...
{
    public partial class AddSecuritySystemUser
    {
        [Inject]
        ...
        {
            securitySystemUser = new SGPA.Server.Models.CMU.SecuritySystemUser();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateSecuritySystemUser(securitySystemUser);
