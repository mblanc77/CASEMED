...
{
    public partial class AddTramiteInfoadjuntafotocarne
    {
        [Inject]
        ...
        {
            tramiteInfoadjuntafotocarne = new SGPA.Server.Models.CMU.TramiteInfoadjuntafotocarne();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateTramiteInfoadjuntafotocarne(tramiteInfoadjuntafotocarne);
