...
{
    public partial class AddSecuritySystemObjectPermissionsObject
    {
        [Inject]
        ...
        {
            securitySystemObjectPermissionsObject = new SGPA.Server.Models.CMU.SecuritySystemObjectPermissionsObject();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateSecuritySystemObjectPermissionsObject(securitySystemObjectPermissionsObject);
