...
{
    public partial class EditKpiscorecardscorecardsKpiinstanceindicator
    {
        [Inject]
        ...
        {
            kpiscorecardscorecardsKpiinstanceindicator = await CMUService.GetKpiscorecardscorecardsKpiinstanceindicatorByOid(oid:OID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateKpiscorecardscorecardsKpiinstanceindicator(oid:OID, kpiscorecardscorecardsKpiinstanceindicator);
