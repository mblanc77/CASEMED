...
{
    public partial class AddAgenteCobranza
    {
        [Inject]
        ...
        {
            agenteCobranza = new SGPA.Server.Models.CMU.AgenteCobranza();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateAgenteCobranza(agenteCobranza);
