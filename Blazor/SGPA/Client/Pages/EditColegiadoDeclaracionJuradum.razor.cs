...
{
    public partial class EditColegiadoDeclaracionJuradum
    {
        [Inject]
        ...
        {
            colegiadoDeclaracionJuradum = await CMUService.GetColegiadoDeclaracionJuradumById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateColegiadoDeclaracionJuradum(id:Id, colegiadoDeclaracionJuradum);
