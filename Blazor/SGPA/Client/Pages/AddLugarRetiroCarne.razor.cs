...
{
    public partial class AddLugarRetiroCarne
    {
        [Inject]
        ...
        {
            lugarRetiroCarne = new SGPA.Server.Models.CMU.LugarRetiroCarne();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateLugarRetiroCarne(lugarRetiroCarne);
