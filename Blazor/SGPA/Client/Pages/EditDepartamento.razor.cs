...
{
    public partial class EditDepartamento
    {
        [Inject]
        ...
        {
            departamento = await CMUService.GetDepartamentoById(id:Id);
        }
        protected bool errorVisible;
        protected SGPA.Server.Models.CMU.Departamento departamento;
        ...
        protected async Task regionalsForRegionalLoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(departamento.Regional, null))
                {
                    var valueResult = await CMUService.GetRegionals(filter: $"Id eq {departamento.Regional}");
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateDepartamento(id:Id, departamento);
