...
{
    public partial class AddContactoInfoAdicional
    {
        [Inject]
        ...
        {
            contactoInfoAdicional = new SGPA.Server.Models.CMU.ContactoInfoAdicional();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateContactoInfoAdicional(contactoInfoAdicional);
