...
{
    public partial class EditCategoriaColegiadoValor
    {
        [Inject]
        ...
        {
            categoriaColegiadoValor = await CMUService.GetCategoriaColegiadoValorById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateCategoriaColegiadoValor(id:Id, categoriaColegiadoValor);
