...
{
    public partial class EditColegiadoTarjetaDebitoAsociadum
    {
        [Inject]
        ...
        {
            colegiadoTarjetaDebitoAsociadum = await CMUService.GetColegiadoTarjetaDebitoAsociadumById(id:Id);
        }
        protected bool errorVisible;
        protected SGPA.Server.Models.CMU.ColegiadoTarjetaDebitoAsociadum colegiadoTarjetaDebitoAsociadum;
        ...
        protected async Task agenteCobranzaDebitosForAgenteDebitoLoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(colegiadoTarjetaDebitoAsociadum.AgenteDebito, null))
                {
                    var valueResult = await CMUService.GetAgenteCobranzaDebitos(filter: $"Id eq {colegiadoTarjetaDebitoAsociadum.AgenteDebito}");
        ...
        protected async Task colegiadosForColegiadoLoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(colegiadoTarjetaDebitoAsociadum.Colegiado, null))
                {
                    var valueResult = await CMUService.GetColegiados(filter: $"Documento eq {colegiadoTarjetaDebitoAsociadum.Colegiado}");
                    var firstItem = valueResult.Value.FirstOrDefault();
                    if (firstItem != null)
                    {
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateColegiadoTarjetaDebitoAsociadum(id:Id, colegiadoTarjetaDebitoAsociadum);
                ...
                DialogService.Close(colegiadoTarjetaDebitoAsociadum);
            }
            catch (Exception ex)
            {
                errorVisible = true;
