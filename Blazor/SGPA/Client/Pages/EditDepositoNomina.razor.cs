...
{
    public partial class EditDepositoNomina
    {
        [Inject]
        ...
        {
            depositoNomina = await CMUService.GetDepositoNominaById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateDepositoNomina(id:Id, depositoNomina);
