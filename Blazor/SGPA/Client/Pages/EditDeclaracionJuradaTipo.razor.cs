...
{
    public partial class EditDeclaracionJuradaTipo
    {
        [Inject]
        ...
        {
            declaracionJuradaTipo = await CMUService.GetDeclaracionJuradaTipoById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateDeclaracionJuradaTipo(id:Id, declaracionJuradaTipo);
