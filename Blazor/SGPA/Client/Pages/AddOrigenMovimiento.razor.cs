...
{
    public partial class AddOrigenMovimiento
    {
        [Inject]
        ...
        {
            origenMovimiento = new SGPA.Server.Models.CMU.OrigenMovimiento();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateOrigenMovimiento(origenMovimiento);
