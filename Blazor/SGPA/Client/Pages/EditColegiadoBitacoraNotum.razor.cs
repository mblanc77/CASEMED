...
{
    public partial class EditColegiadoBitacoraNotum
    {
        [Inject]
        ...
        {
            colegiadoBitacoraNotum = await CMUService.GetColegiadoBitacoraNotumById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateColegiadoBitacoraNotum(id:Id, colegiadoBitacoraNotum);
