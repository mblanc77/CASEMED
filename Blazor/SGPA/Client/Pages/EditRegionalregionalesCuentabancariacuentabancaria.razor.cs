...
{
    public partial class EditRegionalregionalesCuentabancariacuentabancaria
    {
        [Inject]
        ...
        {
            regionalregionalesCuentabancariacuentabancaria = await CMUService.GetRegionalregionalesCuentabancariacuentabancariaByOid(oid:OID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateRegionalregionalesCuentabancariacuentabancaria(oid:OID, regionalregionalesCuentabancariacuentabancaria);
