...
{
    public partial class EditColegiadoImagene
    {
        [Inject]
        ...
        {
            colegiadoImagene = await CMUService.GetColegiadoImageneById(id:Id);
        }
        protected bool errorVisible;
        protected SGPA.Server.Models.CMU.ColegiadoImagene colegiadoImagene;
        ...
        protected async Task colegiadosForColegiadoLoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(colegiadoImagene.Colegiado, null))
                {
                    var valueResult = await CMUService.GetColegiados(filter: $"Documento eq {colegiadoImagene.Colegiado}");
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateColegiadoImagene(id:Id, colegiadoImagene);
                ...
                DialogService.Close(colegiadoImagene);
            }
            catch (Exception ex)
            {
                errorVisible = true;
