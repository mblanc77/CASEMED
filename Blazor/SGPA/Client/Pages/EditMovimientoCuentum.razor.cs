...
{
    public partial class EditMovimientoCuentum
    {
        [Inject]
        ...
        {
            movimientoCuentum = await CMUService.GetMovimientoCuentumById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateMovimientoCuentum(id:Id, movimientoCuentum);
