...
{
    public partial class AddColegiadoCambioCategorium
    {
        [Inject]
        ...
        {
            colegiadoCambioCategorium = new SGPA.Server.Models.CMU.ColegiadoCambioCategorium();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateColegiadoCambioCategorium(colegiadoCambioCategorium);
