...
{
    public partial class AddSalaReservaRegistro
    {
        [Inject]
        ...
        {
            salaReservaRegistro = new SGPA.Server.Models.CMU.SalaReservaRegistro();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateSalaReservaRegistro(salaReservaRegistro);
