...
{
    public partial class EditSecuritySystemObjectPermissionsObject
    {
        [Inject]
        ...
        {
            securitySystemObjectPermissionsObject = await CMUService.GetSecuritySystemObjectPermissionsObjectByOid(oid:Oid);
        }
        protected bool errorVisible;
        protected SGPA.Server.Models.CMU.SecuritySystemObjectPermissionsObject securitySystemObjectPermissionsObject;
        ...
        protected async Task securitySystemTypePermissionsObjectsForOwnerLoadData(LoadDataArgs args)
        {
            try
            {
                ...
                if (!object.Equals(securitySystemObjectPermissionsObject.Owner, null))
                {
                    var valueResult = await CMUService.GetSecuritySystemTypePermissionsObjects(filter: $"Oid eq {securitySystemObjectPermissionsObject.Owner}");
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateSecuritySystemObjectPermissionsObject(oid:Oid, securitySystemObjectPermissionsObject);
                ...
                DialogService.Close(securitySystemObjectPermissionsObject);
            }
            catch (Exception ex)
            {
                errorVisible = true;
