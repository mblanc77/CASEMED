...
{
    public partial class EditColegiado
    {
        [Inject]
        ...
        {
            colegiado = await CMUService.GetColegiadoByDocumento(documento:Documento);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateColegiado(documento:Documento, colegiado);
