...
{
    public partial class AddAjusteRetroactivo
    {
        [Inject]
        ...
        {
            ajusteRetroactivo = new SGPA.Server.Models.CMU.AjusteRetroactivo();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateAjusteRetroactivo(ajusteRetroactivo);
