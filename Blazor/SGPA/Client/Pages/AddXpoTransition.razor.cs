...
{
    public partial class AddXpoTransition
    {
        [Inject]
        ...
        {
            xpoTransition = new SGPA.Server.Models.CMU.XpoTransition();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateXpoTransition(xpoTransition);
