...
{
    public partial class AddAuditDataItemPersistent
    {
        [Inject]
        ...
        {
            auditDataItemPersistent = new SGPA.Server.Models.CMU.AuditDataItemPersistent();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateAuditDataItemPersistent(auditDataItemPersistent);
