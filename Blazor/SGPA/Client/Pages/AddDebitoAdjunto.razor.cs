...
{
    public partial class AddDebitoAdjunto
    {
        [Inject]
        ...
        {
            debitoAdjunto = new SGPA.Server.Models.CMU.DebitoAdjunto();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateDebitoAdjunto(debitoAdjunto);
