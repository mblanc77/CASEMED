...
{
    public partial class EditSalaReserva
    {
        [Inject]
        ...
        {
            salaReserva = await CMUService.GetSalaReservaById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateSalaReserva(id:Id, salaReserva);
