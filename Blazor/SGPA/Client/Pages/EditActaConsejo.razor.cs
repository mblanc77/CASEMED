...
{
    public partial class EditActaConsejo
    {
        [Inject]
        ...
        {
            actaConsejo = await CMUService.GetActaConsejoById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateActaConsejo(id:Id, actaConsejo);
