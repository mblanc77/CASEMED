...
{
    public partial class EditRegistroColegiadoNotificacion
    {
        [Inject]
        ...
        {
            registroColegiadoNotificacion = await CMUService.GetRegistroColegiadoNotificacionById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateRegistroColegiadoNotificacion(id:Id, registroColegiadoNotificacion);
