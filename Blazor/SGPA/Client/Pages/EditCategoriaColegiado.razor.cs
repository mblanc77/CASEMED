...
{
    public partial class EditCategoriaColegiado
    {
        [Inject]
        ...
        {
            categoriaColegiado = await CMUService.GetCategoriaColegiadoById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateCategoriaColegiado(id:Id, categoriaColegiado);
