...
{
    public partial class AddColegiadoTarjetaDebitoAsociadum
    {
        [Inject]
        ...
        {
            colegiadoTarjetaDebitoAsociadum = new SGPA.Server.Models.CMU.ColegiadoTarjetaDebitoAsociadum();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateColegiadoTarjetaDebitoAsociadum(colegiadoTarjetaDebitoAsociadum);
