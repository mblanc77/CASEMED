...
{
    public partial class AddXpoStateAppearance
    {
        [Inject]
        ...
        {
            xpoStateAppearance = new SGPA.Server.Models.CMU.XpoStateAppearance();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateXpoStateAppearance(xpoStateAppearance);
