...
{
    public partial class EditDeclaracionJuradaAdjunto
    {
        [Inject]
        ...
        {
            declaracionJuradaAdjunto = await CMUService.GetDeclaracionJuradaAdjuntoById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateDeclaracionJuradaAdjunto(id:Id, declaracionJuradaAdjunto);
