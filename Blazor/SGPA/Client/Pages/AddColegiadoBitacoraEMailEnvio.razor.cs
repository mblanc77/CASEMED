...
{
    public partial class AddColegiadoBitacoraEMailEnvio
    {
        [Inject]
        ...
        {
            colegiadoBitacoraEMailEnvio = new SGPA.Server.Models.CMU.ColegiadoBitacoraEMailEnvio();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateColegiadoBitacoraEMailEnvio(colegiadoBitacoraEMailEnvio);
