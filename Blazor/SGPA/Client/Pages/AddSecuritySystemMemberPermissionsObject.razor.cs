...
{
    public partial class AddSecuritySystemMemberPermissionsObject
    {
        [Inject]
        ...
        {
            securitySystemMemberPermissionsObject = new SGPA.Server.Models.CMU.SecuritySystemMemberPermissionsObject();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateSecuritySystemMemberPermissionsObject(securitySystemMemberPermissionsObject);
