...
{
    public partial class EditTramiteCarneEstado
    {
        [Inject]
        ...
        {
            tramiteCarneEstado = await CMUService.GetTramiteCarneEstadoByOid(oid:OID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateTramiteCarneEstado(oid:OID, tramiteCarneEstado);
