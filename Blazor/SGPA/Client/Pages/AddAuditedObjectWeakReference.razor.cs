...
{
    public partial class AddAuditedObjectWeakReference
    {
        [Inject]
        ...
        {
            auditedObjectWeakReference = new SGPA.Server.Models.CMU.AuditedObjectWeakReference();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateAuditedObjectWeakReference(auditedObjectWeakReference);
