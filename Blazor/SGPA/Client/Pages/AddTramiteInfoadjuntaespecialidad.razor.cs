...
{
    public partial class AddTramiteInfoadjuntaespecialidad
    {
        [Inject]
        ...
        {
            tramiteInfoadjuntaespecialidad = new SGPA.Server.Models.CMU.TramiteInfoadjuntaespecialidad();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateTramiteInfoadjuntaespecialidad(tramiteInfoadjuntaespecialidad);
