...
{
    public partial class AddDepositoNominaMultiBrou
    {
        [Inject]
        ...
        {
            depositoNominaMultiBrou = new SGPA.Server.Models.CMU.DepositoNominaMultiBrou();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateDepositoNominaMultiBrou(depositoNominaMultiBrou);
