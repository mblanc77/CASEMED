...
{
    public partial class EditKpiHistoryItem
    {
        [Inject]
        ...
        {
            kpiHistoryItem = await CMUService.GetKpiHistoryItemByOid(oid:Oid);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateKpiHistoryItem(oid:Oid, kpiHistoryItem);
