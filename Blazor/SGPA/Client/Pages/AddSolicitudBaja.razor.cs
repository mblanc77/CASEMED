...
{
    public partial class AddSolicitudBaja
    {
        [Inject]
        ...
        {
            solicitudBaja = new SGPA.Server.Models.CMU.SolicitudBaja();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateSolicitudBaja(solicitudBaja);
