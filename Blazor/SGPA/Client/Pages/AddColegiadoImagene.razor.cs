...
{
    public partial class AddColegiadoImagene
    {
        [Inject]
        ...
        {
            colegiadoImagene = new SGPA.Server.Models.CMU.ColegiadoImagene();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateColegiadoImagene(colegiadoImagene);
