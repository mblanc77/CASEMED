...
{
    public partial class EditTramiteCarneEstadoWorkFlow
    {
        [Inject]
        ...
        {
            tramiteCarneEstadoWorkFlow = await CMUService.GetTramiteCarneEstadoWorkFlowByOid(oid:OID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.UpdateTramiteCarneEstadoWorkFlow(oid:OID, tramiteCarneEstadoWorkFlow);
