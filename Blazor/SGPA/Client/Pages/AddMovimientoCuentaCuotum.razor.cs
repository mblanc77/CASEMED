...
{
    public partial class AddMovimientoCuentaCuotum
    {
        [Inject]
        ...
        {
            movimientoCuentaCuotum = new SGPA.Server.Models.CMU.MovimientoCuentaCuotum();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateMovimientoCuentaCuotum(movimientoCuentaCuotum);
