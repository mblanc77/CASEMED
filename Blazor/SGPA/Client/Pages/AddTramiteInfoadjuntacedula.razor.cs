...
{
    public partial class AddTramiteInfoadjuntacedula
    {
        [Inject]
        ...
        {
            tramiteInfoadjuntacedula = new SGPA.Server.Models.CMU.TramiteInfoadjuntacedula();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateTramiteInfoadjuntacedula(tramiteInfoadjuntacedula);
