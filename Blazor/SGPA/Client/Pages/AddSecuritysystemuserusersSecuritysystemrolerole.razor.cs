...
{
    public partial class AddSecuritysystemuserusersSecuritysystemrolerole
    {
        [Inject]
        ...
        {
            securitysystemuserusersSecuritysystemrolerole = new SGPA.Server.Models.CMU.SecuritysystemuserusersSecuritysystemrolerole();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await CMUService.CreateSecuritysystemuserusersSecuritysystemrolerole(securitysystemuserusersSecuritysystemrolerole);
